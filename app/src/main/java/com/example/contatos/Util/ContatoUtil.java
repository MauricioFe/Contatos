...
public class ContatoUtil {
    public static void inserirContato(Context context, String nome, String telefone, String endereco, Bitmap foto) {
        /*Lista de operações a serem realizada em batch*/
        ...
        int backRefIndex = 0;
        //Assocoia o contato à conta padrão do telefone
        ...
        operation.add(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI)
                ...
                .withValue(ContactsContract.CommonDataKinds.StructuredPostal.FORMATTED_ADDRESS, endereco).build());
        ...
        try {
            context.getContentResolver().applyBatch(ContactsContract.AUTHORITY, operation);
